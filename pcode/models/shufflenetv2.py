...
class ShuffleNetV2(nn.Module):
    def __init__(self, net_size, dataset, save_activations=False):
        ...
        self.input_size = 47 if dataset == "emnist" else 10

        self.conv1 = nn.Conv2d(self.input_size, 24, kernel_size=3, stride=1, padding=1, bias=False)
    ...
    def _decide_num_classes(self):
        if self.dataset in ["mnist", "fmnist", "svhn", "cifar10"]:
            return 10
