...
def _get_fashionmnist(conf, root, split, transform, target_transform, download):
    is_train = split == "train"
    normalize = (
        transforms.Normalize((0.5,), (0.5,)) if conf.pn_normalize else None
    )
...
def _get_emnist(conf, root, split, transform, target_transform, download):
    is_train = split == "train"
    normalize = (
        transforms.Normalize((0.5,), (0.5,)) if conf.pn_normalize else None
    )
...
def get_dataset(
    ...
    if name == "cifar10" or name == "cifar100":
        ...
        return _get_emnist(conf, root, split, transform, target_transform, download)
    elif name == "femnist":
        return _get_femnist(conf, root, split, transform, target_transform, download)
    elif name == "fashionmnist":
        return _get_fashionmnist(conf, root, split, transform, target_transform, download)
