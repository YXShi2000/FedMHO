...
def get_args():
    ...
    parser.add_argument("--port", default="50012", type=str)
    ...
    parser.add_argument(
        "--pn_normalize", default=True, type=str2bool, help="normalize images in dataset by mean/std."
    )
    ...
    parser.add_argument(
        ...
        # default="resnet20",
        default="resnet8",
        help="server model architecture: " + " | ".join(
            model_names) + " (default: resnet8)",
    )
    ...
    parser.add_argument(
        ...
        "--complex_arch", type=str, default="master=resnet8,worker=resnet8"
    )
    ...
    parser.add_argument("--ml_local_n_epochs", type=int, default=1)
    parser.add_argument("--dynamic_local_n_epochs", type=str2bool, default=False)
    parser.add_argument("--global_n_epochs", type=int, default=10)
    ...
    parser.add_argument("--one_shot", default=False, type=str2bool)
    parser.add_argument("--latent_size", type=int, default=2)
    parser.add_argument("--fedcvae", default=False, type=str2bool)
    parser.add_argument("--num_synthesis_sample", default=6000, type=int)
    parser.add_argument("--cvae_local_epoch", default=0, type=int)
    parser.add_argument("--is_md", default=True, type=str2bool)
    parser.add_argument("--is_sd", default=False, type=str2bool)
    ...
    #     default=1,
    #     type=int,
    #     help="scale of the clients.",
    # )
    parser.add_argument("--is_serial", default=False, type=str2bool)
    parser.add_argument(
        "--participation_ratio",
        default=0.1,
        type=float,
    ...
    parser.add_argument("--lr_ml", type=float, default=0.01)
    parser.add_argument(
        "--lr_scheduler",
        type=str,
        default="MultiStepLR",
    ...
    # regularization
    parser.add_argument("--svm_l_type", default="L1", type=str, help="L0 L1 L2 or L1L2")
    parser.add_argument("--svm_c", default=0, type=float, help="svm parameter c")
    parser.add_argument("--svm_beta", default=1.0, type=float, help="proportion of weight L2 in L1L2")
    parser.add_argument(
        "--weight_decay", default=1e-4, type=float, help="weight decay (default: 1e-4)"
    )
    ...
    parser.add_argument("--timestamp", default="True", type=str)
    ...
    parser.add_argument("--display_tracked_time", default=True, type=str2bool)
    ...
    parser.add_argument(
        ...
        "--python_path", type=str, default="$HOME/anaconda3/envs/pytorch_mpi/bin/python3.6"
    )
    parser.add_argument("--world", default=None, type=str)
    # parser.add_argument("--world_conf", default=None, type=str)
    parser.add_argument("--world_conf", default="0,0,1,1,100", type=str)
    ...
    parser.add_argument("--hostfile", type=str,
                        default="/home/dzyao/shiyuexin/federated-learning-public-code/codes/FedDF-code/hostfile")
    ...
    # others
    parser.add_argument("--use_hog_feature", default=False, type=str2bool)
